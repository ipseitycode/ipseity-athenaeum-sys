...
copyWithReplace(
    "home/model/example-layout/configuration/IpseityAthenaeumExampleConfiguration.php",
    "$basePath/configuration/IpseityAthenaeum{$Nome}Configuration.php",
    $Nome,
    $nome
);

copyWithReplace(
    "home/model/example-layout/widget/IpseityAthenaeumExampleWidget.php",
    "$basePath/widget/IpseityAthenaeum{$Nome}Widget.php",
    $Nome,
    $nome
);

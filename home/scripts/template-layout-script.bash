...
sed "s/Example/$Nome/g; s/example/$nome/g" home/model/example-layout/configuration/IpseityAthenaeumExampleConfiguration.php > "${nome}-layout/configuration/IpseityAthenaeum${Nome}Configuration.php"

# Copiar e substituir Widget
sed "s/Example/$Nome/g; s/example/$nome/g" home/model/example-layout/widget/IpseityAthenaeumExampleWidget.php > "${nome}-layout/widget/IpseityAthenaeum${Nome}Widget.php"
